...
const UploadPage: React.FC = () => {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    if (formData.file) {
      alert(`Enviando documento: ${formData.documentName} e arquivo: ${formData.file.name}`);
    } else {
  ...
  return (
    <div className="upload-container">
      ...
      <p className="subtitle">Preencha os dados e carregue o arquivo no final.</p>
      ...
      <form onSubmit={handleSubmit} className="document-form">
        ...
        <button type="submit" className="submit-button" disabled={!formData.file || !formData.documentName}>
